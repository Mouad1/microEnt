...
test.describe('Activity Report Generator E2E Tests', () => {
  ...
  test('should navigate to dashboard', async ({ page }) => {
    ...
    const dashboardLink = page.locator('a[href="/dashboard"], [routerLink="/dashboard"]');
  ...
  test('should navigate to activity report', async ({ page }) => {
    ...
    const activityReportLink = page.locator('a[href="/activity-report"], [routerLink="/activity-report"]');
